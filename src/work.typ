...
//
// # Notes
// - Any field in the work experience that is of tpye `content` will not be
//   modified.
...
//
// # Notes
// -  If the work section's title is passed as tpye `str`, the title will be
...
#let show-work-section(work, list-marker: none, date-format: none) = {
  ...
  for experience in named-experiences.values() + unnamed-experiences {
    c += list(
      marker: list-marker,
